...
export function BottomCta({ totalMetrics, totalLive, totalStatic }: BottomCtaProps) {
  ...
  return (
    <>
      {/* ═══════════ BOTTOM CTA ═══════════ */}
      <section className="border-t border-white/10 bg-sv-950 py-16">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link href="/explore" className="group flex items-center gap-2 rounded-md bg-[#0a0a0a] px-8 py-4 font-semibold text-white transition-all hover:bg-white/10">
      ...
      {/* ── Source Footer ── */}
      <div className="border-t border-white/10 bg-[#0d0d0d] py-6">
