...
export function SecuritySection() {
  ...
  return (
    <section className="border-b border-white/10 bg-[#0d0d0d] py-12 lg:py-16" id="security-highlight">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-serif text-2xl font-extrabold text-white">{t("dash.securityTitle")}</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="row-span-2 flex flex-col justify-between rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
            <div>
          ...
          <div className="rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
            ...
            <div className="text-3xl font-extrabold text-white">94,844+</div>
          ...
          <div className="rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
            ...
            <div className="text-3xl font-extrabold text-white">40,000</div>
