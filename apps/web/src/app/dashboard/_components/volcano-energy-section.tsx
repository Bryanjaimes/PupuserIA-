...
export function VolcanoEnergySection() {
  ...
  return (
    <section className="border-b border-white/10 py-12 lg:py-16" id="volcano-energy">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-serif text-2xl font-extrabold text-white">{t("dash.volcanoTitle")}</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="col-span-1 sm:col-span-2 rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
